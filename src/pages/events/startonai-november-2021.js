...
const EventPage = () => {
  return (
    <>
      <Head>
        <title>StartOnAI | App Dev League</title>
        <meta name="description" content="The ADL-StartOnAI Workshop is a one-day interactive event that covers the basics of Artificial Intelligence"></meta>
        <meta property="og:description" content="The ADL-StartOnAI Workshop is a one-day interactive event that covers the basics of Artificial Intelligence"></meta>
      </Head>
      <PageWrapper
        themeConfig={{
              ...
              >
                <div className="pt-8 pb-5 pt-lg-12 pb-lg-10 px-8 px-lg-10 px-xl-15 card shadow-2 gr-hover-2 transition-200 h-100">
                  <div className="article-block">
                    ...
                    The ADL-StartOnAI Workshop is a one-day interactive event that covers the basics of Artificial Intelligence
                    <br/><br/>
                    This workshop will be held on November 6th from 11 am - 2 pm (EST)
                    <br/><br/>
                    In the workshop, students will learn about the basics of artificial intelligence, machine learning, supervised machine learning, regression theory, and gradient descent. No coding experience is required. This is a great starting point for students looking to learn more about AI.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <ul className="p-0 m-0 list-disc">
                      ...
                      <li className="position-relative font-size-5 heading-default-color pl-0 d-flex mb-7">
                        ...
                        <div>Note: <strong>This course is directed towards middle and high school students who are interested in learning the fundamentals of AI. NO PRIOR PROGRAMMING EXPERIENCE NEEDED</strong></div>
                      </li>
                    </ul>
                  </div>
                </div>
