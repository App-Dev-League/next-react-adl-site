                  ...
                  <div>
                    ...
                    <ul className="p-0 m-0 list-disc">
                      ...
                      <li className="position-relative font-size-5 heading-default-color pl-0 d-flex mb-7">
                        ...
                        <div>Note: this workshop is meant for girls in grades 6-12. NO prior programming experience is required. Whether you are intrigued by applications or need to learn it for a project, you are more than welcome to attend!</div>
                      </li>
                    </ul>
                  </div>
                </div>
